...
func main() {
	...
	//Uncomment each of the test cases separately and run the code
	//-----------Test Case 1------------------------------------------------------------------------------
	components := bg.InitializeComponents("dependency.yaml", compCollec, 1)
	components.SendReq("CompA", bg.Update, 500, 0)
